...
//        holder.tvexpense.setText(data[position].)
        ...
        holder.itemView.setOnClickListener(View.OnClickListener {
            ...
            Navigation.createNavigateOnClickListener(R.id.action_archived_crop_to_expenses_Tracker_Fragment, bundle).onClick(holder.itemView)
        })
        holder.itemView.addexp.setOnClickListener(View.OnClickListener {
            var bundle = bundleOf(
                "cropId" to data[position].cropId
            )
            Navigation.createNavigateOnClickListener(R.id.action_archived_crop_to_add_Expenses_Fragment,bundle).onClick(holder.itemView)
        })
        ...
        holder.itemView.tvaddsubsidy.setOnClickListener(View.OnClickListener {
            ...
            var bundle = bundleOf(
                "cropId" to data[position].cropId)
            Navigation.createNavigateOnClickListener(R.id.action_archived_crop_to_add_Subsidy_Fragment,bundle).onClick(holder.itemView)
        })

        holder.itemView.tvaddincome.setOnClickListener(View.OnClickListener {
            var bundle = bundleOf(
                "cropId" to data[position].cropId)
            Navigation.createNavigateOnClickListener(R.id.action_archived_crop_to_add_Income_Fragment, bundle).onClick(holder.itemView)
